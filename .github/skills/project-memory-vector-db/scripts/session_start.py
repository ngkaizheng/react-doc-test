...
def format_system_message(memory_content: str, has_index: bool) -> str:
    ...
    parts.append("")
    parts.append("🔍 **VECTOR SEARCH AVAILABLE**")
    parts.append("Instead of browsing an index, you can search knowledge by meaning.")
    parts.append("When you need architectural context, troubleshooting knowledge, or feature docs:")
    parts.append("")
    parts.append(f"  python {RETRIEVER_PATH} --query \"<your question>\" --top-k 5")
    parts.append("")
    parts.append("This will return the most relevant sections with file paths and line numbers.")
    parts.append("Use `read_file` with the returned line range to get the full content.")
    parts.append("")
